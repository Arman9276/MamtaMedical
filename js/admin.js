import { initializeApp } from 'https://www.gstatic.com/firebasejs/12.13.0/firebase-app.js';
        ...
        try { setTheme(localStorage.getItem('mm-admin-theme') || 'dark'); } catch (e) { setTheme('dark'); }
        ...
        document.getElementById('googleSignInBtn').addEventListener('click', async () => {
            ...
            try {
                ...
                if (isLocalhost) {
                    // Use popup on localhost — more reliable with Live Server
                    ...
                    // Use redirect on production (GitHub Pages)
                    sessionStorage.setItem('mm-login-intent', '1');
